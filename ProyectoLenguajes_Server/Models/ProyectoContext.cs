...
public partial class ProyectoContext : DbContext
{
    ...
    public virtual DbSet<TipoMetodoPago> TipoMetodoPagos { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Caracteristica>(entity =>
        {
            ...
            entity.HasOne(d => d.IdTipoNavigation).WithMany(p => p.Caracteristicas)
                .HasForeignKey(d => d.IdTipo)
                .HasConstraintName("FK_TipoCaracteristica");
        });
        ...
        {
            entity.HasKey(e => e.IdMetodo).HasName("PK_Metodo");
            ...
            entity.HasOne(d => d.IdTipoNavigation).WithMany(p => p.MetodoPagos)
                .HasForeignKey(d => d.IdTipo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ID_Tipo_Metodo");
        ...
        {
            entity.HasKey(e => e.IdTipo).HasName("PK_TipoCaracteristica");

            entity.ToTable("Tipo_Caracteristica");

            entity.Property(e => e.IdTipo).HasColumnName("ID_Tipo");
            entity.Property(e => e.Nombre).HasMaxLength(50);
        });

        modelBuilder.Entity<TipoMetodoPago>(entity =>
        {
            entity.HasKey(e => e.IdTipoMetodo).HasName("PK_TipoMetodo");

            entity.ToTable("Tipo_Metodo_Pago");

            entity.Property(e => e.IdTipoMetodo).HasColumnName("ID_Tipo_Metodo");
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534DD4C3C50").IsUnique();
